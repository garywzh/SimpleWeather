...
public class AddressInfo {
    ...
    /**
     * location : {"lat":40,"lng":116.36} address : 北京市海淀区清华东路 formatted_addresses :
     * {"recommend":"海淀区石油大院内学院路20号院西北450米","rough":"海淀区石油大院内"} address_component :
     * {"nation":"中国","province":"北京市","city":"北京市","district":"海淀区","street":"清华东路","street_number":""}
    ...
    public static class ResultBean {
        ...
        /**
         * recommend : 海淀区石油大院内学院路20号院西北450米 rough : 海淀区石油大院内
         */
        ...
        /**
         * adcode : 110108 name : 中国,北京市,北京市,海淀区 location : {"lat":40,"lng":116.360001} nation : 中国
        ...
        public static class AddressReferenceBean {
            ...
            /**
             * title : 清华东路/志新西路(路口) location : {"lat":40.001339,"lng":116.364731} _distance : 424.5
             * _dir_desc : 西
             */

            public CrossroadBean crossroad;
            /**
             * title : 清华东路 location : {"lat":40.001167,"lng":116.359962} _distance : 124.2
             * _dir_desc : 南
             */

            public StreetBean street;
            /**
             * title : 学院路 location : {"lat":39.995811,"lng":116.363731} _distance : 0 _dir_desc :
             * 内
             */

            public FamousAreaBean famous_area;
            /**
             * title : location : {"lat":40.001167,"lng":116.359962} _distance : 124.2 _dir_desc :
             * 南
             */

            public StreetNumberBean street_number;
            /**
             * title : 学院路街道 location : {"lat":40,"lng":116.360001} _distance : 0 _dir_desc : 内
             */

            public TownBean town;
            /**
             * title : 学院路20号院(东区) location : {"lat":39.997028,"lng":116.364014} _distance : 476
             * _dir_desc : 西北
             */
