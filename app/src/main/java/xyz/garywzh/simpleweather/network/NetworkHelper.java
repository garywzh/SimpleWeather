...
public class NetworkHelper {
    ...
    public static Observable<DataBundle> fetchDataWithLocation(final SimpleLocation simpleLocation) {
        return Observable
                .just(simpleLocation)
    ...
    private static Observable.Transformer<SimpleLocation, DataBundle> locationToBundle(final boolean isLocal) {
        return new Observable.Transformer<SimpleLocation, DataBundle>() {
            @Override
            public Observable<DataBundle> call(Observable<SimpleLocation> simpleLocationObservable) {
